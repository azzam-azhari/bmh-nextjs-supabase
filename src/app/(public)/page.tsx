...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-primary/10 py-12 sm:py-16 md:py-24 lg:py-32">
        <div className="container px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center space-y-6 sm:space-y-8 max-w-4xl mx-auto">
            ...
            {/* Heading */}
            {/* Menambahkan xl:text-7xl untuk layar ekstra besar */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-foreground max-w-3xl">
              Aksi Nyata untuk{' '}
            ...
            {/* Description */}
            {/* Sedikit menaikkan ukuran teks untuk xl */}
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
              {/* Menyesuaikan ukuran tombol untuk xl jika perlu, misalnya padding */}
            ...
            {/* Stats */}
            {/* Menambahkan ukuran teks yang lebih besar untuk xl */}
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 bg-background">
        <div className="container px-4 sm:px-6 lg:px-8 xl:px-12"> {/* Menambahkan xl:px-12 untuk ruang sisi ekstra di layar besar */}
