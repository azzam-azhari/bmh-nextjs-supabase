                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 text-left">
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 lg:space-y-3 text-sm lg:text-base">
                            ...
                            <li><Link href="/research" className="text-muted-foreground hover:text-primary transition-colors">Riset & Pengembangan</Link></li>
                            <li><Link href="/contact" className="text-muted-foreground hover:text-primary transition-colors">Donasi</Link></li>
                        </ul>
                    </div>
